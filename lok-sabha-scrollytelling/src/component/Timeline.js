...
function updateTimelineLine() {
    ...
    if (firstCard && lastCard) {
        ...
        timelineLine.attr("x1", firstCardX )
                    .attr("x2", lastCardX );
    }
}
